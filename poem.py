...
params_rhyme_red = {"rel_rhy":"red"}
response = requests.get(BASE_URL, params_rhyme_red)
word_list_red = json.loads(response.text)
first_word = random_word_from_word_list(word_list_red)

# Get second word
params_rhyme_blue = {"ml":"blue"}
